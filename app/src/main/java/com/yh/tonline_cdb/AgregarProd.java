...
public class AgregarProd {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.AgregarProd);
        try {
            ...
            Toast.makeText(getApplicationContext(), "ERROR AL AGREGAR! : "+ ex.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void mostrarProducto(){
        Intent mostrarProductos = new Intent(AgregarProd.this, MainActivity.class);
    ...
    private class enviarDatos extends AsyncTask<String,String, String>{
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                Toast.makeText(getApplicationContext(), "ERROR! PRODUCTO NO GUARDADO! : "+e.getMessage(), Toast.LENGTH_LONG).show();
            }
        }
    }
}
